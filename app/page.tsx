  ...
  return (
    <div className="-mt-8 relative">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-1">
        ...
        <section className="py-10">
          <Reveal>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-8">
              প্রেগনেন্সি পিলো <span className="dc-gradient-text">কেন ব্যবহার করবেন?</span>
            </h2>
          </Reveal>
        ...
        {/* DOUBLE-LAYER BENEFITS */}
        <section className="py-10">
          <Reveal>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-8">
              ডাবল লেয়ার প্রেগনেন্সি পিলোর <span className="dc-gradient-text">সুবিধা</span>
            </h2>
          </Reveal>
            ...
            {DOUBLE_LAYER.map((d, i) => (
              <Reveal key={i} delay={i * 70}>
                <div className="rounded-[1.5rem] bg-white p-5 h-full shadow-sm ring-1 ring-brand/5 hover:shadow-soft transition">
                  ...
                  <p className="mt-2 text-sm text-green-700 bg-green-50 rounded-xl px-3 py-2">
          ...
          <div className="mt-8 text-center">
            <a href="#order-form" className="inline-block rounded-2xl bg-accent-dark text-white px-8 py-3.5 font-bold shadow-pink hover:bg-accent transition dc-pulse">
              🛒 এখনই অর্ডার করুন
            </a>
          </div>
        </section>
        ...
        <section className="py-10">
          <Reveal>
            <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-8">
              প্রেগনেন্সি পিলো <span className="dc-gradient-text">কেন আমাদের কাছ থেকে নেবেন?</span>
            </h2>
          </Reveal>
